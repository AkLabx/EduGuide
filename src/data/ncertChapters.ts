...
export const ncertData: ClassSubjects = {
  ...
  "8": {
    "Mathematics": ["Part 1: A Square and A Cube", "Part 1: Power Play", "Part 1: A Story of Numbers", "Part 1: Quadrilaterals", "Part 1: Number Play", "Part 1: We Distribute, Yet Things Multiply", "Part 1: Proportional Reasoning-1", "Part 2: Fractions in Disguise", "Part 2: The Baudhayana–Pythagoras Theorem", "Part 2: Proportional Reasoning–2", "Part 2: Exploring Some Geometric Themes", "Part 2: Tales by Dots and Lines", "Part 2: Algebra Play", "Part 2: Area"],
    ...
    "English": ["Unit 1: The Wit that Won Hearts", "Unit 1: A Concrete Example", "Unit 1: Wisdom Paves the Way", "Unit 2: A Tale of Valour: Major Somnath Sharma and the Battle of Badgam", "Unit 2: Somebody’s Mother", "Unit 2: Verghese Kurien – I Too Had a Dream", "Unit 3: The Case of the Fifth Word", "Unit 3: The Magic Brush of Dreams", "Unit 3: Spectacular Wonders", "Unit 4: The Cherry Tree", "Unit 5: Chapters on Indian scientific pioneers"],
    "Hindi": ["स्वदेश (कविता)", "दो गौरैया (कहानी)", "एक आशीर्वाद (कविता)", "हरिद्वार (पत्र)", "कबीर के दोहे", "एक टोकरी भर मिट्टी", "मत बाँधो", "नए मेहमान", "आदमी का अनुपात", "तरुण के स्वप्न (उद्बोधन)", "जब सिनेमा ने बोलना सीखा", "सुदामा चरित", "जहाँ पहिया हैं", "अकबरी लोटा", "सूरदास के पद", "पानी की कहानी"],
    "Social Science": ["Part 1: Natural Resources and Their Use", "Part 1: Reshaping India’s Political Map", "Part 1: The Rise of the Marathas", "Part 1: The Colonial Era in India", "Part 1: Universal Franchise and India’s Electoral System", "Part 1: The Parliamentary System: Legislature and Executive", "Part 1: Factors of Production", "Part 2: The Story of Indian Farming", "Part 2: India and Her Neighbours", "Part 2: Empires and Kingdoms: 6th to 10th Centuries", "Part 2: Turning Tides: 11th and 12th Centuries", "Part 2: India, a Home to Many (Cultural Heritage)", "Part 2: The State, the Government, and You", "Part 2: Infrastructure: Engine of India’s Development", "Part 2: Banks and the Magic of Finance"],
    "Sanskrit": ["संगच्छध्वं संवदध्वम्", "अल्पानामपि वस्तूनां संहतिः कार्यसाधिका", "सुभाषितरसं पीत्वा जीवनं सफलं कुरु", "प्रणम्यो देशभक्तोऽयं गोपबन्धुर्महामनाः", "गीता सुगीता कर्तव्यम्", "डिजि‍भारतम् – युगपरिवर्तनम्", "मञ्जुलमञ्जूषा सुन्दरसुरभाषा", "पश्यत कोणमैशान्यं भारतस्य मनोहरम्", "कोऽरुक् ? कोऽरुक् ? कोऽरुक् ?", "सन्निमित्ते वरं त्यागः (क-भागः)", "सन्निमित्ते वरं त्यागः (ख-भागः)"]
  },
  "9": {
